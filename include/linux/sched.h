...
struct task_struct {
	...
	unsigned int flagCheckedRawMonitor;  // (1 - se a tarefa foi verificada pelo RAW MONITOR e 0 - caso contrário)
	...
	unsigned int cpu_frequency_min; // Frequencia minima a ser utilizada pela tarefa... Se igual a zero ela eh desconsiderada.
